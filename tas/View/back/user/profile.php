                ...
                <div class="card">
                    <div class="card-header text-center">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <img src="<?= empty($_SESSION['profilePicture']) ? "../assets/images/pff.jpg" : '../../../uploads/'.$_SESSION['profilePicture'] ?>" id="profileImage" class="img-fluid rounded-circle mb-3" alt="User Avatar"
