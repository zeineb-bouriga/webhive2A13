    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($agent['contact_number']); ?></td>
                <td><?php echo $agent['agent_status'] ? 'Available' : 'Unavailable'; ?></td>
                <td align="center">
                    <form method="POST" action="UpdateAgent.php">
                        <input class="btn btn-primary btn-sm" type="submit" name="update" value="Update">
                        <input type="hidden" value="<?php echo htmlspecialchars($agent['agent_id']); ?>" name="agent_id">
                    </form>
                </td>
                <td>
                    <a href="deleteAgent.php?agent_id=<?php echo htmlspecialchars($agent['agent_id']); ?>" class="btn btn-danger btn-sm">Delete</a>
                </td>
            </tr>
        <?php
        }
