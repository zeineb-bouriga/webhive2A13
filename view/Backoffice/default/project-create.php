            ...
            <div class="card-body">
                ...
                <form method="POST" action="" id="delivery-form">
                    <div class="mb-3">
                        ...
                        <textarea id="order-id" name="order_id" class="form-control" rows="1" 
                            placeholder="Enter order ID" required></textarea>
                    ...
                    <div class="mb-3">
                        <label for="delivery-agent-id" class="form-label">Delivery Agent ID</label>
                        <textarea id="delivery-agent-id" name="delivery_agent_id" class="form-control" rows="1" 
                            placeholder="Enter delivery agent ID" required></textarea>
